function showTime() { 
	...
	var startDate = new Date(2011, 10, 01);
	...
	var currentTimeString = "雨欣:<br>"
		...
		+"<c style=\"color: #CCFF99; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:24px\" >" +seconds+" </c>sec&nbsp&nbsp&nbsp&nbsp<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >  ----小郑</c>"; 
